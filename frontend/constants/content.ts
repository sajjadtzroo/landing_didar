...
export const CONTENT = {
  ...
  shop: {
    ...
    bestSellersEyebrow: 'محبوب مشتریان',
  ...
  account: {
    ...
    errTooMany: 'تعداد درخواست‌ها بیش از حد مجاز است. لطفاً حدود یک ساعت دیگر دوباره تلاش کنید.',
    // Panel chrome
  ...
  chat: {
    launcher: 'گفتگو با پشتیبانی',
    title: 'پشتیبانی دیدار',
    subtitle: 'معمولاً در ساعات کاری پاسخ می‌دهیم.',
    placeholder: 'پیام خود را بنویسید…',
    send: 'ارسال',
    typing: 'در حال نوشتن…',
    loginPrompt: 'برای گفتگو با پشتیبانی ابتدا وارد حساب کاربری شوید.',
    loginCta: 'ورود / ثبت‌نام',
    reconnecting: 'در حال اتصال مجدد…',
    empty: 'سلام! چطور می‌توانیم کمکتان کنیم؟',
    resolved: 'این گفتگو بسته شده است. با ارسال پیام جدید دوباره باز می‌شود.',
  },
